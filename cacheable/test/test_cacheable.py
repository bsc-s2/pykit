...
class TestLRU(unittest.TestCase):
    ...
    def check_lru_head_and_tail(self, lc):
    ...
    def test_lru_timeout(self):
        ...
        for case_name, case in cases.items():
            ...
            try:
                ...
                self.assertTrue(self.check_lru_head_and_tail(lc))
...
class TestProcessWiseCache(unittest.TestCase):
    ...
    def test_cache_deepcopy(self):
        ...
        mm = TestMem()
        val_mem = mm.test_deepcopy('param1')
        val_mem[0] = 100
        self.assertNotEqual(mm.test_deepcopy('param1')[0], 100)

        val = test_deepcopy('param2')
        val[0] = 101
        self.assertNotEqual(test_deepcopy('param2')[0], 101)
