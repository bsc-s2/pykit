...
class TestProcessWiseCache(unittest.TestCase):
    ...
    def test_get_items_from_cache(self):
        ...
        for ip, ether_hostname in ip_to_mac_and_hostname_table.items():
            ...
            self.assertEqual(mm.get_ether_hostname_inmember(ip), ether_hostname)
...
@cacheable.ProcessWiseCache.cache('ip.ether.hostname', capacity=100, timeout=4, deref=False, key_extractor=key_extractor_funtion)
